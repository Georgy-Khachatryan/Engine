...
template<typename LightAccumulatorT>
void EvaluateBRDF(
	...
	if (any(shadowed_light_irradiance > 0.0)) {
		shadowed_light_irradiance *= TraceShadowRay(shading_position, shading_info.light_direction, shading_info.shadow_ray_length);
	}
