...
s32 main() {
	...
	while (window->should_close == false) {
		...
		GizmoControls(camera_entity, entity_system, undo_redo_system, selected_entities_hash_table, &draw_list_3d, float2(window_pos), float2(window_size), use_local_space_gizmo);
