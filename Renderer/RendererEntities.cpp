...
static void UpdateMeshAssetTypeGpuComponents(StackAllocator* alloc, RecordContext* record_context, AssetEntitySystem& asset_system, Array<GpuComponentUploadBuffer>& gpu_uploads) {
	ProfilerScope("UpdateMeshAssetTypeGpuComponents");
...
static void UpdateTextureAssetTypeGpuComponents(StackAllocator* alloc, RecordContext* record_context, AssetEntitySystem& asset_system, Array<GpuComponentUploadBuffer>& gpu_uploads) {
	ProfilerScope("UpdateTextureAssetTypeGpuComponents");
...
static void UpdateMaterialAssetTypeGpuComponents(StackAllocator* alloc, RecordContext* record_context, AssetEntitySystem& asset_system, Array<GpuComponentUploadBuffer>& gpu_uploads) {
	ProfilerScope("UpdateMaterialAssetTypeGpuComponents");
	
	auto texture_streams = ExtractComponentStreams<TextureAssetType>(QueryEntityTypeArray<TextureAssetType>(asset_system));
	auto* entity_array = QueryEntityTypeArray<MaterialAssetType>(asset_system);
...
void UpdateRendererAssetGpuComponents(StackAllocator* alloc, RecordContext* record_context, AssetEntitySystem& asset_system, Array<GpuComponentUploadBuffer>& gpu_uploads) {
	...
	UpdateMeshAssetTypeGpuComponents(alloc, record_context, asset_system, gpu_uploads);
	UpdateTextureAssetTypeGpuComponents(alloc, record_context, asset_system, gpu_uploads);
	UpdateMaterialAssetTypeGpuComponents(alloc, record_context, asset_system, gpu_uploads);
