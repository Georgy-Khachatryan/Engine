...
template<typename T>
inline void CreateResourceDescriptor(RecordContext* record_context, const T& descriptor, u32 descriptor_heap_offset) {
	...
	descriptor_table->descriptor_heap_offset = descriptor_heap_offset;
